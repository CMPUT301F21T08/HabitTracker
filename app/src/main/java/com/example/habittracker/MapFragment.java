...
//
//
//public class MapFragment extends Fragment implements PassMapDataInterface {
//
//
...
//
//
//    PassMapDataInterface passMapDataInterface;
//
...
//                passMapDataInterface.onDataReceived("map data sending by fragment");
//
//
//
...
////
////
////                Intent i = new Intent((Activity) getActivity(), HabitEventEditActivity.class);
////                String the_value = choose_location_info.getText().toString();
////
////
...
//
//
////                ((Activity) getActivity()).getResult();
//            }
//        });
//
//
...
//        choose_location_info.append(""+data);
//
//    }
//
